...
// Mostrar el estado actual del setup
        ...
        Text(
            text = "Modo de uso actual: ${if (IsAssistedMode) "Asistente" else "Individual"}",
            fontSize = 16.sp,
            modifier = Modifier.padding(5.dp)
        )
        Row {
            Button(onClick = setToAssistedMode) {
                Text(text = "Modo Asistente")
            }
            Button(onClick = setToIndividualMode) {
        ...
        Column() {
            ...
            Text(
                text = "Tamaño de fuente actual: $fontSize",
            ...
            Text(
                text = "Lista de colores del tema actual",
                style = MaterialTheme.typography.headlineSmall
            )
